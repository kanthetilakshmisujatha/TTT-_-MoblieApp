...
const Gallery = () => {
 ...
 const renderItem = ({ item }) => (
    <TouchableOpacity activeOpacity={0.9} style={styles.card}>
      ...
      {/* Pink-to-transparent gradient overlay */}
      <LinearGradient
        colors={['transparent', 'rgba(255, 107, 157, 0.8)']}
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        <Text style={styles.headerText}>గ్యాలరీ</Text>
        <View style={styles.dot} />
        <View style={styles.line} />
        <TouchableOpacity>
          <Text style={styles.seeAll}>అన్నీ చూడండి</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 15,
    backgroundColor: '#1a1a2e', // ProfileScreen deep blue-purple
  },
  ...
  line: {
    flex: 1,
    height: 1.5,
    backgroundColor: 'rgba(255, 107, 157, 0.3)', // Light pink line
    marginLeft: 10,
  },
  seeAll: {
    color: '#FF6B9D',
  ...
  card: {
    ...
    overflow: 'hidden',
    marginBottom: 22,
    backgroundColor: 'rgba(255, 255, 255, 0.05)', // Glassmorphic
    borderWidth: 1,
    borderColor: 'rgba(255, 255, 255, 0.1)',
    elevation: 6,
    shadowColor: '#FF6B9D', // Pink glow
  ...
  labelContainer: {
    ...
    backgroundColor: '#FF6B9D', // Solid PINK
    paddingVertical: 5,
